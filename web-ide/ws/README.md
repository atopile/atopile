...
├── ws/
│   ├── README.md             # This file
│   ├── ARCH.md               # Networking and runtime architecture
│   ├── TESTING.md            # E2E validation workflow
│   ├── Dockerfile            # Multi-stage image build
│   ├── docker-compose.yml    # Local development setup
│   ├── scripts/              # Runtime and validation scripts
│   ├── setup/                # Build-time install/config steps
│   └── branding/             # Branding assets and patch script
└── spawner/                  # Fly playground/spawner service
```

The default example workspace is copied from `examples/quickstart/` during image build.
