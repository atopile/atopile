...
except ModuleNotFoundError:  # autolayout domain not present in this branch
    AutolayoutCandidate = Any  # type: ignore[assignment,misc]
    AutolayoutJob = Any  # type: ignore[assignment,misc]
    AutolayoutState = Any  # type: ignore[assignment,misc]
