...
class TestOrchestratorOutput:
    def test_sanitize_tool_output_removes_internal_keys(self) -> None:
        payload = {
            "path": "main.ato",
    ...
    def test_build_function_call_outputs_attaches_datasheet_file(self) -> None:
    ...
    def test_build_function_call_outputs_nudges_after_parts_install(self) -> None:
        outputs = _build_function_call_outputs_for_model(
            call_id="call_456",
    ...
    def test_extract_retry_after_delay_from_message_text(self) -> None:
    ...
    def test_responses_create_retries_on_429(self, monkeypatch) -> None:
    ...
    def test_responses_create_compacts_and_retries_on_context_overflow(self) -> None:
        orchestrator = AgentOrchestrator()
    ...
    def test_prompt_cache_key_is_stable_for_same_inputs(self) -> None:
    ...
    def test_trim_user_message_preserves_head_and_tail(self) -> None:
        message = "A" * 120 + "B" * 120
    ...
    def test_build_worker_loop_guard_message_detects_repetitive_discovery(self) -> None:
        traces = [
            ToolTrace(
    ...
    def test_build_worker_loop_guard_message_ignores_execution_progress(self) -> None:
        traces = [
            ToolTrace(
                name="project_read_file",
                args={"path": "main.ato"},
