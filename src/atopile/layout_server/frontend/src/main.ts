...
const syncTheme = () => editor.syncTheme();
new MutationObserver(() => requestAnimationFrame(syncTheme)).observe(document.body, { attributes: true, attributeFilter: ["class", "style"] });
syncTheme();
