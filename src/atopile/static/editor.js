...
function paintPad(layer, fpAt, pad, colorOverride) {
...
function paintPadOutline(layer, fpAt, pad, color) {
...
function paintPadHighlight(layer, fpAt, pad) {
