...
def handle_search_registry(
    ...
    if project_root:
        installed_map = get_all_installed_packages([project_root])
...
def handle_packages_summary(
    ...
    if project_root:
        installed = get_all_installed_packages([project_root])
...
def handle_get_packages(
    ...
    packages_map = get_all_installed_packages([Path(project_root)])
    if include_registry:
...
def handle_get_package_details(
    ...
    if project_root:
        packages_map = get_all_installed_packages([project_root])
...
def handle_get_package_info(
    ...
    packages_map = get_all_installed_packages([project_root]) if project_root else {}
    if package_id in packages_map:
