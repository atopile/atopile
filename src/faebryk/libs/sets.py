...
from faebryk.libs.units import HasUnit, Unit, dimensionless
...
class _SupportsRangeOps(Protocol):
    ...
    def __sub__(self, __value: Self) -> "_SupportsRangeOps": ...
    def __add__(self, __value: Self) -> "_SupportsRangeOps": ...
