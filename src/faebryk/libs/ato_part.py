...
class AtoPart:
    ...
    def dump(self):
        ...
        if self.datasheet:
            (self.path / f"{self.identifier}.pdf").write_bytes(self.datasheet)
        ...
        if self.datasheet_url:
            ato_builder.add_trait("has_datasheet_defined", datasheet=self.datasheet_url)
