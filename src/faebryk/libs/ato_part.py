...
from faebryk.libs.util import compare_dataclasses, try_or
...
class AtoPart:
    ...
    def load(cls, path: Path) -> Self:
        ...
        auto_args = try_or(
            lambda: _parse_trait("is_auto_generated", ["system", "date", "checksum"]),
            catch=ValueError,
        )
        datasheet = try_or(
            lambda: _parse_trait("has_datasheet_defined", ["datasheet"])["datasheet"],
            catch=ValueError,
        )
