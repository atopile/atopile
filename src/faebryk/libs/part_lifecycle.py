...
class PartLifecycleError(Exception):
    """
    Base class for part lifecycle errors.
    """

    pass


class IngestFootprintError(PartLifecycleError):
    """
    Error while ingesting part.
    """

    pass


class PartIsNotAutoGenerated(PartLifecycleError):
    """
...
class PartLifecycle:
    ...
    class Library:
        ...
        def _fix_package_footprint_model(
            ...
            if project_path is None:
                raise PartLifecycleError(f"No project path found for {fp_path}")
    ...
    class PCB:
        ...
        def ingest_footprint(
            ...
            if not designator_t or not (ref := designator_t.get_designator()):
