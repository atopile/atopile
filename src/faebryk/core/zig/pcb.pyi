...
# Enum: E_fill
type E_fill = Literal["yes", "no", "none", "solid"]

# Enum: E_knockout
type E_knockout = Literal["knockout"]

# Enum: E_paper_type
type E_paper_type = Literal[
    "A5",
    "A4",
    "A3",
    "A2",
...
# Enum: E_paper_orientation
type E_paper_orientation = Literal["portrait", "landscape"]

# Enum: E_layer_type
type E_layer_type = Literal["signal", "user", "mixed", "jumper", "power"]

# Enum: E_fp_text_type
type E_fp_text_type = Literal["user", "reference", "value"]

# Enum: E_pad_type
type E_pad_type = Literal["thru_hole", "smd", "np_thru_hole", "connect"]

# Enum: E_pad_shape
type E_pad_shape = Literal[
    "circle", "rect", "oval", "roundrect", "custom", "trapezoid", "chamfered_rect"
]

# Enum: E_pad_clearance
type E_pad_clearance = Literal["outline", "convexhull"]

# Enum: E_pad_anchor
type E_pad_anchor = Literal["rect", "circle"]

# Enum: E_pad_property
type E_pad_property = Literal[
    "pad_prop_bga",
...
# Enum: E_pad_drill_shape
type E_pad_drill_shape = Literal["circle", "oval"]

# Enum: E_pad_tenting
type E_pad_tenting = Literal["front", "back", "none"]

# Enum: E_zone_connection
type E_zone_connection = Literal["INHERITED", "NONE", "THERMAL", "FULL", "THT_THERMAL"]

# Enum: E_padstack_mode
type E_padstack_mode = Literal["front_inner_back", "custom"]

# Enum: E_via_tenting
type E_via_tenting = Literal["front", "back"]

# Enum: E_zone_hatch_mode
type E_zone_hatch_mode = Literal["edge", "full", "none"]

# Enum: E_zone_connect_pads_mode
type E_zone_connect_pads_mode = Literal[
    "no", "yes", "thermal_reliefs", "thru_hole_only"
]

# Enum: E_zone_fill_mode
type E_zone_fill_mode = Literal["hatch", "polygon"]

# Enum: E_zone_fill_enable
type E_zone_fill_enable = Literal["yes"]

# Enum: E_zone_smoothing
type E_zone_smoothing = Literal["fillet", "chamfer", "none"]

# Enum: E_zone_hatch_border_algorithm
type E_zone_hatch_border_algorithm = Literal["hatch_thickness", "min_thickness"]

# Enum: E_zone_island_removal_mode
type E_zone_island_removal_mode = Literal["always", "do_not_remove", "below_area_limit"]

# Enum: E_zone_keepout
type E_zone_keepout = Literal["allowed", "not_allowed"]

# Enum: E_zone_placement_source_type
type E_zone_placement_source_type = Literal["sheetname", "component_class"]

# Enum: E_zone_teardrop_type
type E_zone_teardrop_type = Literal["padvia", "track_end"]

# Enum: E_dimension_type
type E_dimension_type = Literal["aligned", "orthogonal", "leader", "center", "radial"]

# Enum: E_dimension_arrow_direction
type E_dimension_arrow_direction = Literal["inward", "outward"]

# Enum: E_copper_finish
type E_copper_finish = Literal[
    "ENIG",
    "ENEPIG",
    "HAL SnPb",
    "HAL lead-free",
...
# Enum: E_edge_connector
type E_edge_connector = Literal["bevelled", "yes"]

# Enum: E_embedded_file_type
type E_embedded_file_type = Literal["other", "model", "font", "datasheet", "worksheet"]
...
class PadDrill:
    ...
    def __init__(
        self, shape: str, size_x: float | None, size_y: float | None, offset: Xy | None
    ) -> None: ...
    def __repr__(self) -> str: ...
