...
# Enum: E_fill_type
type E_fill_type = Literal["background", "none", "outline"]

# Enum: E_stroke_type
type E_stroke_type = Literal["solid", "default"]

# Enum: E_pin_type
type E_pin_type = Literal[
    "bidirectional",
    "free",
    "input",
    "no_connect",
...
# Enum: E_sheet_pin_type
type E_sheet_pin_type = Literal[
    "bidirectional", "input", "output", "passive", "tri_state"
]

# Enum: E_global_label_shape
type E_global_label_shape = Literal[
    "input",
    "output",
    "bidirectional",
    "tri_state",
