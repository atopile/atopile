...
class Crystal_Oscillator(Module):
    ...
    usage_example = L.f_field(F.has_usage_example)(
        example="""
        import Crystal_Oscillator, ElectricPower, Electrical
        ...
        module UsageExample:
            ...
            crystal_osc.crystal.package = "SMD3x3mm"
            ...
            microcontroller_xtal_in = new Electrical
            microcontroller_xtal_out = new Electrical
            microcontroller_xtal_in ~ crystal_osc.xtal_if.xin
