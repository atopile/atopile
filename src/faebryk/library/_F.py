...
from faebryk.library.is_dynamic_by_connections_alias import is_dynamic_by_connections_alias
from faebryk.library.is_dynamic_by_connections_sum import is_dynamic_by_connections_sum
