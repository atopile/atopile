...
class Relay(Module):
    ...
    usage_example = L.f_field(F.has_usage_example)(
        ...
        module UsageExample:
            ...
            control_signal.line ~ control_mosfet.gate

            # Flyback diode for coil protection
            relay.coil_power.lv ~> flyback_diode ~> relay.coil_power.hv

            # Switch high-power load using normally open contact
            high_power_load = new Electrical
            high_voltage_supply = new Electrical
