...
function applyProgressToMessages(
  ...
  return previous.map((message) => {
    ...
    // Carry forward latest checklist snapshot when present
                    ...
                    {message.checklist && message.checklist.items.length > 0 && (
                      <div className="agent-checklist-panel">
                        <div className="agent-checklist-head">
                          ...
                          <span className="agent-checklist-meta">
                            {message.checklist.items.filter((i) => i.status === 'done').length}/{message.checklist.items.length} done
                          </span>
                        </div>
                        <div className="agent-checklist-progress">
                          <div
                            ...
                            style={{
                              width: `${Math.round(
                                (message.checklist.items.filter((i) => i.status === 'done').length /
                            ...
                            >
                              <span className="agent-checklist-item-icon">
                                ...
                                {item.status === 'not_started' && (
                                  <span className="agent-checklist-item-circle" />
                                )}
                              </span>
